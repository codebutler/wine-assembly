; mw3-gameplay-x87-02-0x00515ad8
; runtime 0x00515ad8  module mech3demo.exe  orig 0x00515ad8
; entries 57732  guest ops 59  retired 3406188  3.10% of window
...
00515b91  d8 4a 08                     fmul dword [edx+0x8]
00515b94  d9 c9                        fxch st(1)
00515b96  de c2                        faddp st(2), st
00515b98  de c1                        faddp st(1), st
00515b9a  d9 5d 84                     fstp dword [ebp-0x7c]
00515b9d  d9 05 a8 78 5b 00            fld dword [0x5b78a8]
00515ba3  d9 e0                        fchs
00515ba5  d8 5d 84                     fcomp dword [ebp-0x7c]
00515ba8  df e0                        fnstsw ax
00515baa  f6 c4 41                     test ah, 0x41
00515bad  74 34                        jz short 0x515be3
