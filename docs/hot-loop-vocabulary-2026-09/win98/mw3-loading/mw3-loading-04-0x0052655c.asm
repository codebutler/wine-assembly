; mw3-loading-04-0x0052655c
; runtime 0x0052655c  module mech3demo.exe  orig 0x0052655c
; entries 1778386  guest ops 13  retired 23119018  1.87% of window

0052655c  0f af 0d 6c c6 6e 00         imul ecx, [0x6ec66c]
