; mw3-loading-13-0x005269a1
; runtime 0x005269a1  module mech3demo.exe  orig 0x005269a1
; entries 122108  guest ops 48  retired 5861184  0.47% of window
; TRUNCATED at --max-ops: no terminator within the window

005269a1  8b cf                        mov ecx, edi
005269a3  8b d7                        mov edx, edi
005269a5  0f af 0d 6c c6 6e 00         imul ecx, [0x6ec66c]
