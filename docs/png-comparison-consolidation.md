...
| Paint dock-toggle | Exact RGB in status-bar rectangle; mismatched dimensions now rejected | Initially failed at 1298 pixels with both comparators. Subsequent zero-extent NCCALCSIZE fix passes at 0/0; residual palette/scrollbar artifacts remain ([findings](re-notes/mspaint.md)) |
