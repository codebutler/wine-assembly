  ...
  const TouchControls = {
    ...
    _centerCornersInGutters(app, host, usableHost) {
      ...
      for (const corner of ['bl', 'br']) {
        ...
        if (active && !pairedKeyboard && !(this.layout && this.layout.screenAnchored) && el.getBoundingClientRect) {
    ...
    _placeModeToggle() {
      ...
      this._utilityRow.style.bottom = 'calc(18px + env(safe-area-inset-bottom, 0px) + ' +
