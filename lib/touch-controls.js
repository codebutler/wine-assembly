...
`;
  ...
  const TouchControls = {
    ...
    syncViewMode() {
      ...
      this._modeEl.textContent = zoom ? ((crop && crop.fitLabel) || 'Fit') : ((crop && crop.zoomLabel) || 'Fill');
      this._modeEl.setAttribute('aria-label', 'switch to ' + this._modeEl.textContent + ' view');
      return this;
    },
    ...
    getBoardArea() {
      ...
      if (host.width > height) {
        const side = Math.min(this.layout && this.layout.mouseJoystick ? 148 : 204, host.width * 0.30);
      ...
      return this._boardArea = { x: left / host.width, y: top / host.height,
        ...
        h: Math.max(1, height - (this.layout && this.layout.mouseJoystick ? 200 : 204) - top) / host.height };
    },
