  ...
  const DESKTOP_APPS = [
    ...
    const APPS = {
      ...
      pinball: {
        ...
        //
        // landscapeView: 'crop' -- in landscape the scarce axis is height, and
        // this table fitted to it fills the screen top to bottom with no bars.
        // The whole-scene alternative is both smaller and letterboxed, so
        // there is nothing to choose between and the chip is not offered.
      ...
      ut2003_demo: {
        ...
        dlls: ['core.dll', 'engine.dll', 'window.dll', 'msvcr70.dll']
