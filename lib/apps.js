    ...
    const APPS = {
      ...
      funtris:    {
        ...
        mobileCrop: { x: 0.028, y: 0.19, w: 0.935, h: 0.68, contain: true,
          // Landscape Fit has 150px+ of empty grey on EACH side at 667x375.
          // The well+score union is 342px wide at 667, 712 and 812px, and
          // remains centred; its top is 51px and the well ends at 361px.
          // Keep an 18px horizontal / 8px vertical margin around that union.
          // Portrait is width-limited, so its whole-window Fit stays intact.
          fitFocusLandscape: { width: 378, top: 43, bottom: 6 } },
