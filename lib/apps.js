  ...
  const DESKTOP_APPS = [
    ...
    const APPS = {
      ...
      snake:    {
        ...
        // x 3..263, y 81..348 -- so the crop is the field including its wall,
        ...
        // Full window WIDTH on purpose. Trimming to the playfield's own
        // 260/266 saves 6px of nothing and costs the score box, which sits
        // hard against the window's right edge (x 350..421 of 424) -- the
        // crop's right edge landed on its border and the readout came out
        // clipped.
        //
        // And the crop STARTS at the score strip (y 47), not at the field's
        // red wall (y 81). Portrait got the strip for free, because `contain`
        // grows the crop back up to reach the screen's aspect -- but landscape
        // is short and grows it not at all, so a field-only crop showed no
        // score whatever. Lives and score are game state in Rattler; they are
        // worth the few percent of board scale that including them costs.
        mobileCrop: { x: 0, y: 47 / 352, w: 1, h: 300 / 352, contain: true },
        touchControls: {
      ...
      pinball: {
        ...
        mobileCrop: { x: 32 / 641, y: 32 / 481, w: 352 / 641, h: 449 / 481,
        ...
        touchControls: {
          ...
          // plunger lane. The top 14% is left un-zoned so the title bar and
          ...
          zones: [
            ...
            { vk: 0xBF, title: 'Right flipper',
              rect: { x: 0.5, y: 0.14, w: 0.5, h: 0.86 } },
            { vk: 0x20, title: 'Plunger',
              rect: { x: 0.88, y: 0.72, w: 0.12, h: 0.25 } },
          ],
          buttons: [
