      ...
      pinball: {
        ...
        touchControls: {
          ...
          buttons: [
            ...
            // F2. A chip rather than a word-pill, and in the opposite bottom
          // corner from the keyboard/Fit row on purpose: it is the one
          // DESTRUCTIVE control on this overlay -- it throws the ball and the
          // score away -- so it stays as far from the flippers, the plunger
          // and the two chips people actually tap as the screen allows.
          { vk: 0x71, icon: 'restart', chip: true, title: 'New game', pos: 'bl' },
          ],
        },
      },
      pinball_plus95: {
