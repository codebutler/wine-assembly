...
(function () {
  ...
  // ---- invite links ------------------------------------------------------
  //
  // ?app=ID&room=USERID: open this game and join that person's room. Nothing
  // on screen hands these out -- the server list is how people find a room --
  // but a link someone builds by hand, or a future share button, lands in the
  // room it names with no list in the way. Only for
