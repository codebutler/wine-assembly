...
void main(){
 ...
 outline_guest();
  ...
  class Device {
    ...
    destroy() { this.gpu.destroy(); this.programs.clear(); this.outlinePrograms.clear(); this.textures.clear(); this.textureTargets.clear(); this.depthTargets.clear(); this.colorTargets.clear(); this.resourceSamples.clear(); this.mipUniforms?.clear(); this.keyedTextures.clear(); this.keyMembers.clear(); this.stageKeys.clear(); this.residentPixels.clear(); }
  }
