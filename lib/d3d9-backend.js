...
void main(){
 ...
 outline_guest();
  ...
  class Device {
    ...
    updateColor(resource,pixels,pitch,rect){if(!this.colorResource(resource))invalid('unknown color resource');
      ...
      this.touchColor(resource);this.gpu.updateColorResource(resource.id,rgba,r);return 1;}
