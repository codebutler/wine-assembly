  ...
  (func $system_ordinal_api_id (param $dll_name_ga i32) (param $ordinal i32) (result i32)
    ...
    (if (i32.or
      ...
      (then
        ...
        (if (i32.eq (local.get $ordinal) (i32.const 51))   (then (return (call $lookup_api_id "gethostbyaddr"))))
        (if (i32.eq (local.get $ordinal) (i32.const 53))   (then (return (call $lookup_api_id "getprotobyname"))))
        (if (i32.eq (local.get $ordinal) (i32.const 54))   (then (return (call $lookup_api_id "getprotobynumber"))))
        (if (i32.eq (local.get $ordinal) (i32.const 55))   (then (return (call $lookup_api_id "getservbyname"))))
        (if (i32.eq (local.get $ordinal) (i32.const 56))   (then (return (call $lookup_api_id "getservbyport"))))
        (if (i32.eq (local.get $ordinal) (i32.const 109))  (then (return (call $lookup_api_id "WSASetBlockingHook"))))
        (if (i32.eq (local.get $ordinal) (i32.const 110))  (then (return (call $lookup_api_id "WSAUnhookBlockingHook"))))
