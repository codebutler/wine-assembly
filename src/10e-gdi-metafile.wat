  ...
  (func $gdi_metafile_enum_invoke (param $ctx i32)
    ...
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (local.get $record_g))
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base))
  ...
  (func $gdi_metafile_enum_start (param $hdc i32) (param $handle i32)
    ...
    (i32.store offset=16 (global.get $reg_base) (i32.sub (local.get $return_esp) (local.get $ctx_size)))
    (local.set $ctx (i32.load offset=16 (global.get $reg_base)))
