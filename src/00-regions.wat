  ...
  (region.declare $UPDATE_RECT (stride 0x10 (count $MAX_WINDOWS)) (align 0x00001000)
    (owner "01-header.wat:$UPDATE_RECT"))
  (region.declare $UPDATE_FLAGS (stride 0x1 (count $MAX_WINDOWS)) (align 0x00001000)
  ...
  (region.declare $WND_BG_BRUSH_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000100)
    (owner "09c0-window-table.wat:$wnd_bg_brush_reset_slot"))
  (region.declare $WND_CLASS_CURSOR_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000100)
  ...
  (region.declare $DIALOG_STATE_TABLE (stride 0x10 (count $MAX_WINDOWS)) (align 0x00001000)
    (owner "09c0-window-table.wat:$dialog_state_addr"))
  (region.declare $WINDOW_UNICODE_TABLE (stride 0x1 (count $MAX_WINDOWS)) (align 0x00001000)
  ...
  (region.declare $WINDOW_EXTRA_TABLE (stride 0x10 (count $MAX_WINDOWS)) (align 0x00000100)
  ...
  ;; what a scan costs follows the windows a program has, not the capacity.
  (region.declare $WND_SLOT_END (size 0x00000004) (align 0x00000004)
    (owner "09c0-window-table.wat:$wnd_slot_end"))
  (region.declare $WND_RECORDS (align 0x00001000)
    (stride 0x18 (count $MAX_WINDOWS))
    (owner "09c0-window-table.wat:$wnd_record_addr"))
  (region.declare $CONTROL_TABLE (stride 0x10 (count $MAX_WINDOWS)) (align 0x00000100)
    (owner "09c3-controls.wat:$ctrl_slot_addr"))
  (region.declare $CONTROL_GEOM (stride 0x8 (count $MAX_WINDOWS)) (align 0x00000100)
  ...
  (region.declare $SCROLL_TABLE (stride 0x18 (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "09c0-window-table.wat:$scroll_record_addr"))
  (region.declare $FLASH_TABLE (stride 0x1 (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "09a5-handlers-window.wat:$handle_FlashWindow"))
  (region.declare $NC_FLAGS (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "10-helpers.wat:$nc_flags_set"))
  (region.declare $TITLE_TABLE (stride 0x8 (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "01-header.wat:$TITLE_TABLE"))
  (region.declare $CLIENT_RECT (stride 0x10 (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "01-header.wat:$CLIENT_RECT"))
  (region.declare $SHOW_STATE_TABLE (stride 0x1 (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "09c4-defwndproc.wat:$wnd_show_state_addr"))
  (region.declare $WINDOW_REGION_BITS (bitmap (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "01-header.wat:$WINDOW_REGION_BITS"))
  (region.declare $NATIVE_STATUS_BITS (bitmap (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "09c3-controls.wat:$statusbar_native_mark_slot"))
  (region.declare $NATIVE_TAB_BITS (bitmap (count $MAX_WINDOWS)) (align 0x00000010)
  ...
  (region.declare $OWNER_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000100)
  ...
  (region.declare $RICHEDIT_FORMAT_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "01-header.wat:$RICHEDIT_FORMAT_TABLE"))
  (region.declare $RICHEDIT_PARA_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000010)
  ...
  (region.declare $LAST_ACTIVE_POPUP_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000100)
  ...
  (region.declare $WND_Z_ORDER_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00001000)
  ...
  (region.declare $WND_OWN_DC_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000100)
    (owner "09c0-window-table.wat:$wnd_own_dc_addr_for_slot"))
  (region.declare $WND_HINSTANCE_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000100)
  ...
  (region.declare $WND_THREAD_TABLE (stride 0x4 (count $MAX_WINDOWS)) (align 0x00000100)
  ...
  (region.declare $GDI_OBJECT_TABLE (size 0x00006000) (align 0x00000100)
    ...
    (owner "10d-gdi-region-path.wat:$gdi_object_record"))
  (region.declare $GDI_WINDOW_SURFACE_TABLE (align 0x00000100)
    (stride $GDI_WINDOW_SURFACE_STRIDE (count $MAX_WINDOWS))
    (owner "10f-gdi-dc.wat:$gdi_window_surface_record"))
  ...
  (region.declare $PAINT_FLAGS (stride 0x1 (count $MAX_WINDOWS)) (align 0x00001000)
  ...
  (region.declare $ICON_TABLE (size 0x00001000) (align 0x00000100)
    (owner "09a4b-handlers-cursor-icon.wat:$icon_intern_sized"))
  (region.declare $ICON_SIZE_TABLE (size 0x00000800) (align 0x00000100)
    (owner "09a4b-handlers-cursor-icon.wat:$icon_slot_size_set"))
  ...
  (region.declare $SCROLL_ARROW_TABLE (align 0x00000100)
    (stride 0x1 (count $MAX_WINDOWS))
    (owner "09c0-window-table.wat:$scroll_arrow_mask_slot"))
  (region.declare $WND_NORMAL_RECT (stride 0x14 (count $MAX_WINDOWS)) (align 0x00000010)
    (owner "09a5b-handlers-window-late.wat:$wnd_normal_addr"))
  (region.declare $SCROLL_AUX_TABLE (stride 0x10 (count $MAX_WINDOWS)) (align 0x00001000)
