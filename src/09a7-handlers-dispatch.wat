  ...
  (func $handle_GetWindowLongA (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    ...
    (if (i32.eq (local.get $arg1) (i32.const -4))   ;; GWL_WNDPROC
      (then
        ...
        ;; A live window's GWL_WNDPROC is never NULL — the WNDPROC_BUILTIN
        ;; sentinel is the default class proc, returned as-is (MFC subclassing
        ;; asserts non-null; CallWindowProc treats it as DefWindowProc).
        (global.set $esp (i32.add (global.get $esp) (i32.const 12))) (return)))
    ...
    (if (i32.eq (local.get $arg1) (i32.const -20))  ;; GWL_EXSTYLE
      (then
        (global.set $eax (i32.const 0))
        (global.set $esp (i32.add (global.get $esp) (i32.const 12))) (return)))
    ;; Positive = the window's cbWndExtra bytes; a separate area from
    ;; GWL_USERDATA (see $wnd_set_long_extra / SetWindowLongA).
    (if (i32.ge_s (local.get $arg1) (i32.const 0))
      (then
        (global.set $eax (call $wnd_get_long_extra (local.get $arg0) (local.get $arg1)))
        (global.set $esp (i32.add (global.get $esp) (i32.const 12))) (return)))
    (global.set $eax (i32.const 0))
    (global.set $esp (i32.add (global.get $esp) (i32.const 12)))  ;; stdcall, 2 args
  )
