  ...
  (func (export "gl_wat_encoder_set_enabled") (param $enabled i32)
    (if (i32.eqz (global.get $gl_wat_selector_locked))
      (then (global.set $gl_wat_enabled (i32.ne (local.get $enabled) (i32.const 0))))))
  (func (export "gl_wat_encoder_enabled") (result i32) (global.get $gl_wat_enabled))
