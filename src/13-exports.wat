      ...
      (if (global.get $trace_esp_flag)
        (then
          (if (i32.and
            ...
            (then (call $host_log_block (global.get $eip) (i32.load offset=16 (global.get $reg_base)))))))
  ...
  (func (export "get_edx") (result i32) (i32.load offset=8 (global.get $reg_base)))
  (func (export "get_ebx") (result i32) (i32.load offset=12 (global.get $reg_base)))
  (func (export "get_ebp") (result i32) (i32.load offset=20 (global.get $reg_base)))
  (func (export "get_esi") (result i32) (i32.load offset=24 (global.get $reg_base)))
  (func (export "get_edi") (result i32) (i32.load offset=28 (global.get $reg_base)))
  ...
  ;; Callers take the whole list (the worker publish), so the bins join it.
  (func (export "get_free_list") (result i32) (call $heap_bins_flush) (global.get $free_list))
  ...
  (func (export "test_call_MaskBlt")
    ...
    (local.set $saved_esp (i32.load offset=16 (global.get $reg_base)))
    (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 24)) (local.get 5))
    (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 28)) (local.get 6))
    (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 32)) (local.get 7))
    (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 36)) (local.get 8))
    (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 40)) (local.get 9))
    (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 44)) (local.get 10))
    (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 48)) (local.get 11))
    (call $handle_MaskBlt
      (local.get 0) (local.get 1) (local.get 2) (local.get 3)
      (local.get 4) (i32.const 0))
    (i32.store offset=16 (global.get $reg_base) (local.get $saved_esp))
  ...
  (func (export "test_cs_park_retry") (param $cs_gp i32) (result i32)
    ...
    (if (i32.and
          ...
          (i32.and (global.get $handler_set_eip)
            (i32.eq (i32.load offset=16 (global.get $reg_base)) (local.get $saved_esp))))
      (then (local.set $bits (i32.or (local.get $bits) (i32.const 1)))))
  ...
  (func $has_pending_message (export "has_pending_message") (result i32)
    ...
    (if (call $nc_track_pending) (then (return (i32.const 1))))
    ...
    ;; Only NC calculation/paint (bits 2/0) are retrieved as messages.
    ;; Pending erase (bit 1) is paint lifecycle state, and bit 3 records
    ;; default erase ownership. Neither alone may spin the message waiter.
    (if (call $nc_flags_scan (i32.const 5))
      (then (return (i32.const 1))))
    ;; The selector mirrors the legacy main-window flag into PAINT_FLAGS
  ...
  (func (export "set_esp") (param i32) (i32.store offset=16 (global.get $reg_base) (local.get 0)))
  (func (export "set_ebp") (param i32) (i32.store offset=20 (global.get $reg_base) (local.get 0)))
  (func (export "set_eax") (param i32) (i32.store offset=0 (global.get $reg_base) (local.get 0)))
  (func (export "set_ecx") (param i32) (i32.store offset=4 (global.get $reg_base) (local.get 0)))
  (func (export "set_edx") (param i32) (i32.store offset=8 (global.get $reg_base) (local.get 0)))
  ...
  (func (export "call_func") (param $addr i32) (param $a0 i32) (param $a1 i32) (param $a2 i32) (param $a3 i32)
    ...
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (local.get $a0))
  ...
  (func (export "test_call_htons") (param $v i32) (result i32)
    ...
    (i32.store offset=16 (global.get $reg_base) (local.get $sp))
    (i32.load offset=0 (global.get $reg_base)))
  (func (export "test_call_htonl") (param $v i32) (result i32)
    (local $sp i32) (local.set $sp (i32.load offset=16 (global.get $reg_base)))
    (call $handle_htonl (local.get $v)
      (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0))
    (i32.store offset=16 (global.get $reg_base) (local.get $sp))
    (i32.load offset=0 (global.get $reg_base)))
  ...
  (func (export "test_call_gethostbyname") (param $n i32) (result i32)
    ...
    (i32.store offset=16 (global.get $reg_base) (local.get $sp))
    (i32.load offset=0 (global.get $reg_base)))
  (func (export "test_call_inet_pton") (param $fam i32) (param $src i32) (param $dst i32) (result i32)
    (local $sp i32) (local.set $sp (i32.load offset=16 (global.get $reg_base)))
    (call $handle_inet_pton (local.get $fam) (local.get $src) (local.get $dst)
      (i32.const 0) (i32.const 0) (i32.const 0))
    (i32.store offset=16 (global.get $reg_base) (local.get $sp))
    (i32.load offset=0 (global.get $reg_base)))
  (func (export "test_call_inet_ntop") (param $fam i32) (param $src i32) (param $dst i32) (param $n i32) (result i32)
    (local $sp i32) (local.set $sp (i32.load offset=16 (global.get $reg_base)))
    (call $handle_inet_ntop (local.get $fam) (local.get $src) (local.get $dst) (local.get $n)
      (i32.const 0) (i32.const 0))
    (i32.store offset=16 (global.get $reg_base) (local.get $sp))
    (i32.load offset=0 (global.get $reg_base)))
  (func (export "test_call_getaddrinfo") (param $node i32) (param $svc i32) (param $hints i32) (param $res i32) (result i32)
    (local $sp i32) (local.set $sp (i32.load offset=16 (global.get $reg_base)))
    (call $handle_getaddrinfo (local.get $node) (local.get $svc) (local.get $hints) (local.get $res)
      (i32.const 0) (i32.const 0))
    (i32.store offset=16 (global.get $reg_base) (local.get $sp))
    (i32.load offset=0 (global.get $reg_base)))
  (func (export "test_call_gethostname") (param $buf i32) (param $len i32) (result i32)
    (local $sp i32) (local.set $sp (i32.load offset=16 (global.get $reg_base)))
