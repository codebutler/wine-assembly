...
;; retain immutable bytes, and return release to the producer after their fence.
  ...
  (func $d3d_shader_ir_compile (export "d3d_shader_ir_compile") (param $ptr i32) (param $count i32) (result i32)
    ...
    (if (i32.and (i32.ne (i32.load (local.get $ptr)) (i32.const 0xfffe0101))
    ...
    (local.set $n (call $d3d_ir_scan (local.get $ptr) (local.get $count) (i32.const 0)))
    ...
    (if (i32.ne (call $d3d_ir_scan (local.get $ptr) (local.get $count) (local.get $ir)) (local.get $n))
