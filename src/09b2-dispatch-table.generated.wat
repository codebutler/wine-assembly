  ...
  (func $dispatch_api_table (param $api_id i32) (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    ...
    (if (i32.lt_u (local.get $api_id) (i32.const 3328))
      (then
        ...
        (return)))
    (if (i32.lt_u (local.get $api_id) (i32.const 3367))
      (then
  ...
  (func $dispatch_api_table_page_13 (param $api_id i32) (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    ...
    (block $api_1
    (block $api_0
      (br_table $api_0 $api_1 $api_2 $api_3 $api_4 $api_5 $api_6 $api_7 $api_8 $api_9 $api_10 $api_11 $api_12 $api_13 $api_14 $api_15 $api_16 $api_17 $api_18 $api_19 $api_20 $api_21 $api_22 $api_23 $api_24 $api_25 $api_26 $api_27 $api_28 $api_29 $api_30 $api_31 $api_32 $api_33 $api_34 $api_35 $api_36 $api_37 $api_38 $fallback (local.get $api_id))
    ) ;; 3328: DirectXSetup
      ...
      (return)
    ) ;; 3355: WritePrivateProfileSectionA
      ...
      (return)
    ) ;; 3363: IDirectPlayLobby3_ConnectEx
      ...
      (return)
    ) ;; 3364: IDirectPlayLobby3_RegisterApplication
      ...
      (return)
    ) ;; 3365: IDirectPlayLobby3_UnregisterApplication
      (call $handle_dplobby3_application_unsupported (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; 3366: IDirectPlayLobby3_WaitForConnectionSettings
  ...
  (func $init_dx_com_thunks (export "init_dx_com_thunks")
    ...
    ;; IDirectPlayLobby3: extends IDirectPlayLobby2 (15) + 4 extra = 19 total, extra at api_id 3363
    (global.set $DX_VTBL_DPLAYLOBBY3 (call $extend_com_vtable
      (global.get $DX_VTBL_DPLAYLOBBY2) (i32.const 15) (i32.const 3363) (i32.const 19)))
  )
