  ...
  ;; BASS_PluginLoad: pop 12, return 0
  ...
  ;; BASS_StreamFree: pop 8, return 1
  ...
  ;; BASS_ChannelStop: pop 8, return 1
  ...
  ;; BASS_ChannelSetAttribute: pop 16, return 1
  ...
  ;; BASS_ChannelSetPosition: pop 20, return 1
  ...
  ;; BASS_ErrorGetCode: pop 4, return 0
  ...
  (func $dispatch_api_table (param $api_id i32) (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    ...
    (if (i32.lt_u (local.get $api_id) (i32.const 3584))
      (then
        ...
        (return)))
    (if (i32.lt_u (local.get $api_id) (i32.const 3614))
      (then
  ...
  (func $dispatch_api_table_page_14 (param $api_id i32) (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    ...
    (block $api_1
    (block $api_0
      (br_table $api_0 $api_1 $api_2 $api_3 $api_4 $api_5 $api_6 $api_7 $api_8 $api_9 $api_10 $api_11 $api_12 $api_13 $api_14 $api_15 $api_16 $api_17 $api_18 $api_19 $api_20 $api_21 $api_22 $api_23 $api_24 $api_25 $api_26 $api_27 $api_28 $api_29 $fallback (local.get $api_id))
    ) ;; 3584: SetConsoleCP
