  ...
  (func $init_dx_com_thunks (export "init_dx_com_thunks")
    ...
    ;; IStorage: 18 methods starting at api_id 2055
    (global.set $DX_VTBL_ISTORAGE (call $init_com_vtable (i32.const 2055) (i32.const 18)))
    ;; IStream: 14 methods starting at api_id 2073
    (global.set $DX_VTBL_ISTREAM (call $init_com_vtable (i32.const 2073) (i32.const 14)))
