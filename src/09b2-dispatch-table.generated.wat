  ...
  (func $dispatch_api_table (param $api_id i32) (param $arg0 i32) (param $arg1 i32) (param $arg2 i32) (param $arg3 i32) (param $arg4 i32) (param $name_ptr i32)
    ...
    (block $api_0
      ...
      (return)
    ) ;; 2047: StartPagePrinter
      (call $handle_StartPagePrinter (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; 2048: EndPagePrinter
      (call $handle_EndPagePrinter (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; 2049: WritePrinter
      ...
      (return)
    ) ;; 2054: QueryDosDeviceW
      (call $handle_QueryDosDeviceW (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; 2055: LoadLibraryExA
      ...
      (return)
    ) ;; 2064: DdeQueryStringA
      (call $handle_DdeQueryStringA (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; 2065: DdeNameService
      ...
      (return)
    ) ;; 2069: DdeCreateDataHandle
      (call $handle_DdeCreateDataHandle (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; 2070: DdeFreeDataHandle
      ...
      (call $handle_DdeAccessData (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; 2072: DdeUnaccessData
      (call $handle_DdeUnaccessData (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; 2073: AddFontResourceA
      ...
      (return)
    ) ;; 2108: StgCreateStorageEx
      (call $handle_StgCreateStorageEx (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; 2109: StgIsStorageFile
      ...
      (return)
    ) ;; 2112: ReadFmtUserTypeStg
      (call $handle_ReadFmtUserTypeStg (local.get $arg0) (local.get $arg1) (local.get $arg2) (local.get $arg3) (local.get $arg4) (local.get $name_ptr))
      (return)
    ) ;; fallback
  ...
  (func $init_dx_com_thunks (export "init_dx_com_thunks")
    ...
    ;; IStorage: 18 methods starting at api_id 2075
    (global.set $DX_VTBL_ISTORAGE (call $init_com_vtable (i32.const 2075) (i32.const 18)))
    ;; IStream: 14 methods starting at api_id 2093
    (global.set $DX_VTBL_ISTREAM (call $init_com_vtable (i32.const 2093) (i32.const 14)))
