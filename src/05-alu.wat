...
;; ============================================================
  ...
  (func $th_mov_r_i32 (param $op i32) (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $read_thread_word)) (return_call $next))
  (func $th_add_r_i32 (param $op i32)
    (local $old i32) (local $imm i32) (local $r i32)
    (local.set $old (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))))) (local.set $imm (call $read_thread_word))
  ...
  (func $th_or_r_i32 (param $op i32)
    (local $r i32) (local.set $r (i32.or (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2)))) (call $read_thread_word)))
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (local.get $r)) (call $set_flags_logic (local.get $r)) (return_call $next))
  ...
  (func $th_and_r_i32 (param $op i32)
    (local $r i32) (local.set $r (i32.and (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2)))) (call $read_thread_word)))
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (local.get $r)) (call $set_flags_logic (local.get $r)) (return_call $next))
  ...
  (func $th_xor_r_i32 (param $op i32)
    (local $r i32) (local.set $r (i32.xor (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2)))) (call $read_thread_word)))
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (local.get $r)) (call $set_flags_logic (local.get $r)) (return_call $next))
  (func $th_cmp_r_i32 (param $op i32)
    (local $a i32) (local $b i32)
    (local.set $a (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))))) (local.set $b (call $read_thread_word))
  ...
  (func $th_mov_r_r (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (i32.shr_u (local.get $op) (i32.const 4)) (i32.const 2))) (i32.load (i32.add (global.get $reg_base) (i32.shl (i32.and (local.get $op) (i32.const 0xF)) (i32.const 2))))) (return_call $next))
  (func $th_add_r_r (param $op i32)
    ...
    (local.set $r (i32.add (local.get $a) (local.get $b)))
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $d) (i32.const 2))) (local.get $r)) (call $set_flags_add (local.get $a) (local.get $b) (local.get $r)) (return_call $next))
  (func $th_or_r_r (param $op i32)
    ...
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $d) (i32.const 2))) (local.get $r)) (call $set_flags_logic (local.get $r)) (return_call $next))
  ...
  (func $th_sub_r_r (param $op i32)
    ...
    (local.set $a (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $d) (i32.const 2))))) (local.set $b (i32.load (i32.add (global.get $reg_base) (i32.shl (i32.and (local.get $op) (i32.const 0xF)) (i32.const 2)))))
    (local.set $r (i32.sub (local.get $a) (local.get $b)))
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $d) (i32.const 2))) (local.get $r)) (call $set_flags_sub (local.get $a) (local.get $b) (local.get $r)) (return_call $next))
  ...
  (func $th_load32 (param $op i32) (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl32 (call $read_addr))) (return_call $next))
  (func $th_store32 (param $op i32) (call $gs32 (call $read_addr) (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))))) (return_call $next))
  ...
  (func $th_load32_ro (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (i32.shr_u (local.get $op) (i32.const 4)) (i32.const 2))) (call $gl32 (i32.add (i32.load (i32.add (global.get $reg_base) (i32.shl (i32.and (local.get $op) (i32.const 0xF)) (i32.const 2)))) (call $read_thread_word))))
    (return_call $next))
  ...
  (func $th_load16_ro (param $op i32)
    (call $set_reg16 (i32.shr_u (local.get $op) (i32.const 4))
      (call $gl16 (i32.add (i32.load (i32.add (global.get $reg_base) (i32.shl (i32.and (local.get $op) (i32.const 0xF)) (i32.const 2)))) (call $read_thread_word))))
    (return_call $next))
  ...
  (func $th_load32_ro_base_eax (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl32 (i32.add (i32.load offset=0 (global.get $reg_base)) (call $read_thread_word))))
    (return_call $next))
  (func $th_load32_ro_base_ecx (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl32 (i32.add (i32.load offset=4 (global.get $reg_base)) (call $read_thread_word))))
    (return_call $next))
  (func $th_load32_ro_base_edx (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl32 (i32.add (i32.load offset=8 (global.get $reg_base)) (call $read_thread_word))))
    (return_call $next))
  (func $th_load32_ro_base_ebx (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl32 (i32.add (i32.load offset=12 (global.get $reg_base)) (call $read_thread_word))))
    (return_call $next))
  (func $th_load32_ro_base_esp (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl32 (i32.add (i32.load offset=16 (global.get $reg_base)) (call $read_thread_word))))
    (return_call $next))
  (func $th_load32_ro_base_ebp (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl32 (i32.add (i32.load offset=20 (global.get $reg_base)) (call $read_thread_word))))
    (return_call $next))
  (func $th_load32_ro_base_esi (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl32 (i32.add (i32.load offset=24 (global.get $reg_base)) (call $read_thread_word))))
    (return_call $next))
  (func $th_load32_ro_base_edi (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl32 (i32.add (i32.load offset=28 (global.get $reg_base)) (call $read_thread_word))))
    (return_call $next))
  ...
  (func $th_push_ecx (param $op i32)
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (i32.load offset=4 (global.get $reg_base)))
    (return_call $next))
  (func $th_push_edx (param $op i32)
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (i32.load offset=8 (global.get $reg_base)))
    (return_call $next))
  (func $th_push_ebx (param $op i32)
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (i32.load offset=12 (global.get $reg_base)))
    (return_call $next))
  (func $th_push_esp (param $op i32)
    (local $v i32)
    (local.set $v (i32.load offset=16 (global.get $reg_base)))
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (local.get $v))
    (return_call $next))
  ...
  (func $th_push_esi (param $op i32)
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (i32.load offset=24 (global.get $reg_base)))
    (return_call $next))
  ...
  (func $th_pop_eax (param $op i32)
    (i32.store offset=0 (global.get $reg_base) (call $gl32 (i32.load offset=16 (global.get $reg_base))))
    (i32.store offset=16 (global.get $reg_base) (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (return_call $next))
  (func $th_pop_ecx (param $op i32)
    (i32.store offset=4 (global.get $reg_base) (call $gl32 (i32.load offset=16 (global.get $reg_base))))
    (i32.store offset=16 (global.get $reg_base) (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (return_call $next))
  (func $th_pop_edx (param $op i32)
    (i32.store offset=8 (global.get $reg_base) (call $gl32 (i32.load offset=16 (global.get $reg_base))))
    (i32.store offset=16 (global.get $reg_base) (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (return_call $next))
  (func $th_pop_ebx (param $op i32)
    (i32.store offset=12 (global.get $reg_base) (call $gl32 (i32.load offset=16 (global.get $reg_base))))
    (i32.store offset=16 (global.get $reg_base) (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (return_call $next))
  (func $th_pop_esp (param $op i32)
    (i32.store offset=16 (global.get $reg_base) (call $gl32 (i32.load offset=16 (global.get $reg_base))))
    (return_call $next))
  ...
  (func $th_pop_esi (param $op i32)
    (i32.store offset=24 (global.get $reg_base) (call $gl32 (i32.load offset=16 (global.get $reg_base))))
    (i32.store offset=16 (global.get $reg_base) (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (return_call $next))
  (func $th_pop_edi (param $op i32)
    (i32.store offset=28 (global.get $reg_base) (call $gl32 (i32.load offset=16 (global.get $reg_base))))
    (i32.store offset=16 (global.get $reg_base) (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (return_call $next))
  (func $th_push_i32 (param $op i32)
    ...
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (local.get $v)) (return_call $next))
  (func $th_pushad (param $op i32)
    (local $tmp i32) (local.set $tmp (i32.load offset=16 (global.get $reg_base)))
  ...
  (func $th_pushfd (param $op i32)
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (call $build_eflags)) (return_call $next))
  (func $th_popfd (param $op i32)
    (call $load_eflags (call $gl32 (i32.load offset=16 (global.get $reg_base))))
  ...
  (func $th_mul_m32 (param $op i32)
    ...
    (i32.store offset=0 (global.get $reg_base) (i32.wrap_i64 (local.get $val)))
    (i32.store offset=8 (global.get $reg_base) (i32.wrap_i64 (i64.shr_u (local.get $val) (i64.const 32))))
    (call $set_flags_mul (i32.ne (i32.load offset=8 (global.get $reg_base)) (i32.const 0))) (return_call $next))
  (func $th_imul_m32 (param $op i32)
    ...
    (i32.store offset=0 (global.get $reg_base) (i32.wrap_i64 (local.get $val)))
    (i32.store offset=8 (global.get $reg_base) (i32.wrap_i64 (i64.shr_s (local.get $val) (i64.const 32))))
    (call $set_flags_mul (i32.ne (i32.load offset=8 (global.get $reg_base)) (i32.shr_s (i32.load offset=0 (global.get $reg_base)) (i32.const 31)))) (return_call $next))
  (func $th_div_m32 (param $op i32)
    ...
    (if (i64.gt_u (local.get $quotient) (i64.const 0xFFFFFFFF))
      (then (call $raise_exception (i32.const 0xC0000094)) (return)))
    (i32.store offset=0 (global.get $reg_base) (i32.wrap_i64 (local.get $quotient)))
    (i32.store offset=8 (global.get $reg_base) (i32.wrap_i64 (i64.rem_u (local.get $dividend) (local.get $divisor)))) (return_call $next))
  (func $th_idiv_m32 (param $op i32)
    ...
    (if (i32.or (i64.gt_s (local.get $quotient) (i64.const 0x7FFFFFFF))
      ...
      (then (call $raise_exception (i32.const 0xC0000094)) (return)))
    (i32.store offset=0 (global.get $reg_base) (i32.wrap_i64 (local.get $quotient)))
    (i32.store offset=8 (global.get $reg_base) (i32.wrap_i64 (i64.rem_s (local.get $dividend) (local.get $divisor)))) (return_call $next))
  ...
  (func $th_not_r (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (i32.xor (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2)))) (i32.const -1))) (return_call $next))
  ...
  ;; --- LEA ---
  (func $th_lea (param $op i32) (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $read_thread_word)) (return_call $next))
  ...
  (func $th_pushf16 (param $op i32)
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 2)))
    (call $gs16 (i32.load offset=16 (global.get $reg_base)) (i32.and (call $build_eflags) (i32.const 0xFFFF))) (return_call $next))
  ;; 254: POPF (16-bit)
  (func $th_popf16 (param $op i32)
    ...
    (i32.store offset=16 (global.get $reg_base) (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 2))) (return_call $next))
  ...
  (func $th_push_m16 (param $op i32)
    ...
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 2)))
    (call $gs16 (i32.load offset=16 (global.get $reg_base)) (local.get $v)) (return_call $next))
  ;; 268: POP [addr] 16-bit
  ...
  (func $th_test_r_i32 (param $op i32)
    (call $set_flags_logic (i32.and (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2)))) (call $read_thread_word))) (return_call $next))
  (func $th_test_m32_r (param $op i32)
    (call $set_flags_logic (i32.and (call $gl32 (call $read_addr)) (i32.load (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2)))))) (return_call $next))
  ...
  ;; --- MOVZX / MOVSX ---
  (func $th_movzx8 (param $op i32) (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl8 (call $read_addr))) (return_call $next))
  ...
  (func $th_movzx16 (param $op i32) (i32.store (i32.add (global.get $reg_base) (i32.shl (local.get $op) (i32.const 2))) (call $gl16 (call $read_addr))) (return_call $next))
  ...
  (func $th_cdq (param $op i32)
    (i32.store offset=8 (global.get $reg_base) (i32.shr_s (i32.load offset=0 (global.get $reg_base)) (i32.const 31))) (return_call $next))
  (func $th_cbw (param $op i32)
    (local $al i32) (local.set $al (i32.and (i32.load offset=0 (global.get $reg_base)) (i32.const 0xFF)))
  ...
  (func $th_cwde (param $op i32)
    (local $ax i32) (local.set $ax (i32.and (i32.load offset=0 (global.get $reg_base)) (i32.const 0xFFFF)))
  ...
  (func $th_pop_r16 (param $op i32)
    (call $set_reg16 (local.get $op) (call $gl16 (i32.load offset=16 (global.get $reg_base))))
  ...
  (func $th_lodsw (param $op i32)
    (call $set_reg16 (i32.const 0) (call $gl16 (i32.load offset=24 (global.get $reg_base))))
    (if (global.get $df)
      (then (i32.store offset=24 (global.get $reg_base) (i32.sub (i32.load offset=24 (global.get $reg_base)) (i32.const 2))))
      (else (i32.store offset=24 (global.get $reg_base) (i32.add (i32.load offset=24 (global.get $reg_base)) (i32.const 2)))))
    (return_call $next))
  ...
  (func $th_test_ax_i16 (param $op i32)
    (local $v i32)
    (local.set $v (i32.and (i32.and (i32.load offset=0 (global.get $reg_base)) (i32.const 0xFFFF)) (call $read_thread_word)))
    (call $set_flags_logic (local.get $v))
    (global.set $flag_sign_shift (i32.const 15)) (return_call $next))
  ...
  (func $th_movzx_r_r8 (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (i32.shr_u (local.get $op) (i32.const 4)) (i32.const 2))) (call $get_reg8 (i32.and (local.get $op) (i32.const 0xF))))
    (return_call $next))
  ...
  (func $th_movzx_r_r16 (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (i32.shr_u (local.get $op) (i32.const 4)) (i32.const 2))) (i32.and (i32.load (i32.add (global.get $reg_base) (i32.shl (i32.and (local.get $op) (i32.const 0xF)) (i32.const 2)))) (i32.const 0xFFFF)))
    (return_call $next))
  (func $th_movsx_r_r16 (param $op i32)
    (i32.store (i32.add (global.get $reg_base) (i32.shl (i32.shr_u (local.get $op) (i32.const 4)) (i32.const 2))) (call $sign_ext16 (i32.load (i32.add (global.get $reg_base) (i32.shl (i32.and (local.get $op) (i32.const 0xF)) (i32.const 2))))))
    (return_call $next))
