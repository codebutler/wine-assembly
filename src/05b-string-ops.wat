  ...
  (func $th_movsb (param $op i32)
    (call $gs8 (i32.load offset=28 (global.get $reg_base)) (call $gl8 (i32.load offset=24 (global.get $reg_base))))
    (if (global.get $df)
  ...
  (func $th_movsd (param $op i32)
    (call $gs32 (i32.load offset=28 (global.get $reg_base)) (call $gl32 (i32.load offset=24 (global.get $reg_base))))
    (if (global.get $df)
  ...
  (func $th_stosb (param $op i32)
    (call $gs8 (i32.load offset=28 (global.get $reg_base)) (i32.and (i32.load offset=0 (global.get $reg_base)) (i32.const 0xFF)))
    (if (global.get $df)
  ...
  (func $th_lodsb (param $op i32)
    (i32.store offset=0 (global.get $reg_base) (i32.or (i32.and (i32.load offset=0 (global.get $reg_base)) (i32.const 0xFFFFFF00)) (call $gl8 (i32.load offset=24 (global.get $reg_base)))))
    (if (global.get $df)
      (then (i32.store offset=24 (global.get $reg_base) (i32.sub (i32.load offset=24 (global.get $reg_base)) (i32.const 1))))
      (else (i32.store offset=24 (global.get $reg_base) (i32.add (i32.load offset=24 (global.get $reg_base)) (i32.const 1)))))
    (return_call $next))
  (func $th_lodsd (param $op i32)
    (i32.store offset=0 (global.get $reg_base) (call $gl32 (i32.load offset=24 (global.get $reg_base))))
    (if (global.get $df)
      (then (i32.store offset=24 (global.get $reg_base) (i32.sub (i32.load offset=24 (global.get $reg_base)) (i32.const 4))))
      (else (i32.store offset=24 (global.get $reg_base) (i32.add (i32.load offset=24 (global.get $reg_base)) (i32.const 4)))))
    (return_call $next))
