  ...
  (func $gdi_font_enum_advance (param $ctx i32)
    ...
    (if (i32.eqz (local.get $candidate))
      (then
        (call $gdi_font_enum_finish (local.get $ctx)
          (select (i32.load offset=0 (global.get $reg_base)) (i32.const 1)
    ...
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (call $gl32 (i32.add (local.get $ctx) (i32.const 8))))
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (call $gdi_bitmap_font_enum_type (local.get $candidate)))
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (local.get $tm_g))
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
    (call $gs32 (i32.load offset=16 (global.get $reg_base)) (local.get $lf_g))
    (i32.store offset=16 (global.get $reg_base) (i32.sub (i32.load offset=16 (global.get $reg_base)) (i32.const 4)))
  ...
  (func $gdi_font_enum_start (param $callback i32) (param $lparam i32)
    ...
    (if (i32.eqz (local.get $callback))
      (then
        ...
        (i32.store offset=16 (global.get $reg_base) (local.get $return_esp))
        (return)))
    (i32.store offset=16 (global.get $reg_base) (i32.sub (local.get $return_esp) (i32.const 560)))
    (local.set $ctx (i32.load offset=16 (global.get $reg_base)))
