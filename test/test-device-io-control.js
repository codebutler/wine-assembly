...
const extraWat = String.raw`
  (func (export "test_device_io_control")
    ...
    (call $gs32 (i32.add (global.get $esp) (i32.const 24)) (local.get $out_size))
    (call $gs32 (i32.add (global.get $esp) (i32.const 28)) (local.get $bytes))
    (call $gs32 (i32.add (global.get $esp) (i32.const 32)) (local.get $overlapped))
