...
(async()=>{
 ...
 const {exports:e,memory,module}=await bootRenderHarness({fonts:'none',extraHostOverrides:{gpu_gl_call:(o,p,a)=>bridge.call(o,p,a),
  ...
  (func (export "reset") (param $d i32) (param $pp i32) (result i32)
    (global.set $esp (i32.const 0x074ff000))
    (call $handle_IDirect3DDevice9_Reset (local.get $d) (local.get $pp) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0)) (global.get $eax))
  ...
  (func (export "clear") (param $d i32) (result i32)
    ...
    (call $handle_IDirect3DDevice9_Clear (local.get $d) (i32.const 0) (i32.const 0) (i32.const 1) (i32.const -65536) (i32.const 0)) (global.get $eax))
  (func (export "present") (param $d i32) (result i32)
    (global.set $esp (i32.const 0x074ff000))
    (call $handle_IDirect3DDevice9_Present (local.get $d) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0)) (global.get $eax))
  ...
  (func (export "texture") (param $d i32) (param $out i32) (result i32)
    (call $d3d9_texture_create (local.get $d) (i32.const 1) (i32.const 1)
      (i32.const 1) (i32.const 0) (i32.const 21) (i32.const 1) (local.get $out)) (global.get $eax))
  (func (export "bindTexture") (param $d i32) (param $stage i32) (param $t i32) (result i32)
    (call $d3d9_texture_binding (local.get $d) (local.get $stage) (local.get $t) (i32.const 0)) (global.get $eax))
  ...
  (func (export "material") (param $d i32) (param $p i32) (result i32)
    (call $d3d9_material (local.get $d) (local.get $p) (i32.const 0)) (global.get $eax))
  (func (export "releaseTexture") (param $t i32) (result i32)
    (global.set $esp (i32.const 0x074ff000))
    (call $handle_IDirect3DTexture9_Release (local.get $t) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0) (i32.const 0)) (global.get $eax))
