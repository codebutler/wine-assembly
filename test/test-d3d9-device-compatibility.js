...
(async () => {
  const { exports: e } = await bootRenderHarness({ fonts: 'none', extraWat: `
    ...
    (func (export "check_type") (param $adapter i32) (param $type i32)
      ...
      (call $gs32 (i32.add (global.get $esp) (i32.const 20)) (i32.const 0x11223344))
      (call $gs32 (i32.add (global.get $esp) (i32.const 24)) (local.get $windowed))
      (call $gs32 (i32.add (global.get $esp) (i32.const 28)) (i32.const 0x55667788))
    ...
    (func (export "check_depth") (param $adapter i32) (param $type i32)
      ...
      (global.set $esp (i32.const ${STACK}))
      (call $gs32 (i32.add (global.get $esp) (i32.const 20)) (i32.const 0x11223344))
      (call $gs32 (i32.add (global.get $esp) (i32.const 24)) (local.get $depth_format))
      (call $gs32 (i32.add (global.get $esp) (i32.const 28)) (i32.const 0x55667788))
