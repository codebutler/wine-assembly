...
record('set_block_exec_split', 0);       // ON by default: zero is the meaningful value
...
assert(!cliSource.includes('gl_wat_encoder_set_enabled'),
  'CLI must not select the retired JavaScript encoder');
