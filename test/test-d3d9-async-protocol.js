...
(async()=>{
  ...
  for(let opcode=0x30001;opcode<=0x30015;opcode++)assert.strictEqual(imports.gpu_gl_call(opcode,123,456),91);
  assert.deepStrictEqual(routed,Array.from({length:21},(_,i)=>[0x30001+i,123,456]),
