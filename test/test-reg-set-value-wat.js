...
const extraWat = String.raw`
  ...
  (func (export "test_reg_create_key_ex_a")
    ...
    (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 32)) (local.get $phk))
    (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 36)) (local.get $disp))
