...
(async () => {
  ...
  const harness = await bootRenderHarness({
    ...
    (func (export "test_call_CreateIcon")
      ...
      (local $saved_esp i32)
      (local.set $saved_esp (i32.load offset=16 (global.get $reg_base)))
      (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 24)) (local.get $and_bits))
      (call $gs32 (i32.add (i32.load offset=16 (global.get $reg_base)) (i32.const 28)) (local.get $xor_bits))
